 ...
 * 用来加载用户浏览菜谱记录的
 */
public class UserMenuRecordRecycleViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public UserMenuRecordRecycleViewAdapter(Context context , List<Record> records){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_NORMAL) {
            itemView = mInflater.inflate(R.layout.menu_layout_record_item, parent, false);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if(holder instanceof MenuViewHolder){
            ...
            Menu menu = records.get(position).getMenus();
            Glide.with(context)
            ...
            mHolder.mDeleteRecord.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    mListener.remove(holder.getAdapterPosition());
                }
            });
    ...
    //上拉加载更多
    public void addMoreItem(List<Record> list) {
        records.addAll(list);
...
//        notifyDataSetChanged();
    ...
    protected class MenuViewHolder extends RecyclerView.ViewHolder{
        ...
        public MenuViewHolder(View menu) {
            ...
            mDeleteRecord = (ImageView) menu.findViewById(R.id.id_iv_delete_record);
        }
    }
    ...
    public void setmListener(IMenuOnClickListener mListener) {

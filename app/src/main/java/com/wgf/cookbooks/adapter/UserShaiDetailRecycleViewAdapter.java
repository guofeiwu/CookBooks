 ...
 * 晒一晒的适配器类
 */
public class UserShaiDetailRecycleViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public UserShaiDetailRecycleViewAdapter(Context context, List<Shai> shaiLists) {
       ...
       if (viewHolder instanceof FooterViewHolder) {
            ...
            holder.mlike.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    mIShaiClickListener.like(position);
                }
            });
            ...
            holder.mComment.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    mIShaiClickListener.comment(position);
                }
            });
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    mIShaiClickListener.detail(position);
                }
            });

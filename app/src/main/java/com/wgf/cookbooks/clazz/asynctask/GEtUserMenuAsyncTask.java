 ...
 * 获取用户的菜谱
 */
public class GetUserMenuAsyncTask extends AsyncTask<Integer,Void,Void> {
    private IGetUserMenuListener mListener;
    private Context context;
    public GetUserMenuAsyncTask(Context context){
        this.context = context;
    }
    @Override
    protected Void doInBackground(Integer... params) {
        int pageNo = params[0];
        String url = BASE_URL+"/app/menu/user/"+pageNo;
        OkGo.<String>get(url)
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        if(code == SUCCESS){
                            ...
                            mListener.userMenus(list);
                        }else{
                            mListener.userMenus(null);
                        }
                    }
                    @Override
    ...
    public interface IGetUserMenuListener{
        void userMenus(List<Menu> list);
    }

    public void setmListener(IGetUserMenuListener mListener) {
